...
#       'subscription',
        ...
        'l10n_multilang'],
    'data': [
         'glip_debranding/view_debranding.xml',
         'glip_improvements_menus/reorganize.xml',
         'glip_improvements_crm/mods_crm_leads.xml',
        ...
        'views/mods_projects.xml',
        'views/mods_res_partner.xml',
        'views/mods_documents.xml', 
    ...
    'qweb': ['glip_debranding/view_mods_to_base.xml','view_mods_to_webclient_templates.xml', ],
